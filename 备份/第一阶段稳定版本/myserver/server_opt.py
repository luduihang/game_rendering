    ...
    def add_client(self, client_socket, user_id, username, password):
        with self.lock:
            if len(self.clients) < self.max_clients:
                ...
                self.card_table[user_id] = {"username": username,"gender":user_inform["gender"],"preparing": False,"money":user_inform["money"],"bet_money":0}
        ...
        try:
            while self.is_running:
                try:
                    ...
                    if not data:  # 如果没有数据接收到，客户端可能已经断开连接
