...
class Draw_Pic:
    def __init__(self,id):
        ...
        self.key_handle = MouseClickHandler(self.window_surface)
    ...
    def login(self):
        ...
        self.font = pygame.font.Font(font_spirit.Destination['ShangShouHanShuTi'],20)
        text = self.font.render('抵制不良游戏，拒绝盗版游戏。注意自我保护，谨防受骗上当。', True, Color.white)  # 白色文本
        self.window_surface.blit(text, (700,750))

        self.font = pygame.font.Font(font_spirit.Destination['ShangShouHanShuTi'], 30)
        text = self.font.render('用户注册', True, Color.white)  # 白色文本
        self.window_surface.blit(text, button_spirit.Location['register'])
    ...
    def register(self):
        self.window_surface.blit(self.login_bk_img, (0, 0))
        arr_icon = ['back', 'frame', 'age', 'user', 'password']
        public_login_pic(arr_icon, self.window_surface)
